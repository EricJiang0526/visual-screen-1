<template>
	<div class="list-wrapper">
		...
		<el-collapse v-model="activeNames">
			<el-collapse-item v-for="group in componentGroupList" :key="group.group" :title="group.title" :name="group.group">
				<div class="group-wrapper">
					...
					>
						<img :src="`src/assets/Thumbnail/${item.picUrl}`" alt="" width="106" height="60" />
						<div class="name">
							{{ item.name }}
						</div>
					</div>
